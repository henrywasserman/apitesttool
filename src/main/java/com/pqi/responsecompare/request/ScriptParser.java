		...
		for (int i = 0; i < counter; i++) {
			...
			for (File responsecomparefile : responsecomparefiles) {
				...
				ArrayList<String> allValidCommands = new ArrayList<String>(
						Arrays.asList(
								"ADD_ROLE_TO_USER_FROM_CSV",
								"ASSIGN",
								"BODY","BASIC_AUTHORIZATION",
								"BODY_FILE","COMPARE_VARIABLES",
								"CREATE_AUTOMATION_ROLE",
								"CREATE_PATIENT_PORTAL_USER",
								"CREATE_AGNOSTIC_PROPERTIES",
								"CREATE_JSON_FOR_ROLE",
								"CUSTOM_MAP",
								"CREATE_PATIENTS_FROM_CSV",
								"CREATE_USERS",
								"EXPECT_ERROR",
								"DELETE","ELSE","GENERATE_GUID",
								"GET",
								...
								"POST_IMAGE", "POST_IMAGES", "POST", "POST_MULTIPART","POST_WITH_AUTHCACHE",
								"REMOTE_SHELL","RELOAD_ENVIRONMENT_AGNOSTIC_PROPERTIES","JAVASCRIPT",
								"POST_WITH_FILE_BODY","POST_XML_SUBS", "PUT", "SET_DATETIME",
								"VALIDATE_HEADER","RUN_SQL","SKIP_COMPARE","TESTRAIL",
								"VALIDATE_HEADER_SET", "VALIDATE_HEADER_NOTEXIST",
								"VALIDATE_IMAGE", "VALIDATE_IMAGES",
								"TRANSFORM_RESPONSE_FILE","VALIDATE_RAW_RESPONSE",
								"VALIDATE_STATUS_CODE", "SET_HEADER",
								"QUERY_STRING", "COMPARE", "STATUS",
								"SQL", "VALIDATE_DATA", "VERIFY_ICD","VERIFY_RESPONSE_TEXT",
