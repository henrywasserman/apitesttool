...
public class SSLPostMultiPart extends Request {
	static Logger logger = Logger.getLogger(SSLPostMultiPart.class);

	public SSLPostMultiPart(TestCase test) throws Exception {
		super(test);
	}
